...
NewChatWindow.Filter[1] = UI.GetCliloc(SystemData.Settings.Language.type, 337)
NewChatWindow.Filter[2] = UI.GetCliloc(SystemData.Settings.Language.type, 338)
NewChatWindow.Filter[3] =  UI.GetCliloc(SystemData.Settings.Language.type, 339)
NewChatWindow.Filter[4] =  UI.GetCliloc(SystemData.Settings.Language.type, 340)
NewChatWindow.Filter[5] = UI.GetCliloc(SystemData.Settings.Language.type, 341)
NewChatWindow.Filter[6] = UI.GetCliloc(SystemData.Settings.Language.type, 342)
NewChatWindow.Filter[7] = UI.GetCliloc(SystemData.Settings.Language.type, 343)
NewChatWindow.Filter[8] = UI.GetCliloc(SystemData.Settings.Language.type, 344)
NewChatWindow.Filter[9] = UI.GetCliloc(SystemData.Settings.Language.type, 345)
NewChatWindow.Filter[10] = UI.GetCliloc(SystemData.Settings.Language.type, 346)
...
function NewChatWindow.SetVisible()
	WindowSetShowing(NewChatWindow.WindowName, EnhancePack.UseNewChat)
	WindowSetShowing(NewChatWindow.WindowName .. "JournalWindow", EnhancePack.UseNewChat)
	for i = 1, NewChatWindow.maxTabs do
		local templatename = "Bookmark" .. i
		if (DoesWindowNameExist(templatename)) then
			WindowSetShowing(templatename, EnhancePack.UseNewChat)
		end
		if (DoesWindowNameExist("NewChatWindow" .. i)) then
			WindowSetShowing("NewChatWindow" .. i, EnhancePack.UseNewChat)
		end
		if (DoesWindowNameExist("NewChatWindowBookmark" .. i)) then
			WindowSetShowing("NewChatWindowBookmark" .. i, EnhancePack.UseNewChat)
		end
	end
end
...
function NewChatWindow.OnKeyTab()
	...
	EnhancePack.ChatWindowSwitchChannelWithExistingText (ChatWindowContainerTextInput.Text)
end
...
function NewChatWindow.DragBar()
	...
	if (id > 0 and IsMobile(id)) then
		EnhancePack.CreateHealthBar(id)
	else
		WindowSetId(this, 0)
...
function NewChatWindow.Initialize()
	...
	for i= 1, NewChatWindow.maxTabs do
		...
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.SAY ]           = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.SAY,false )
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.WHISPER ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.WHISPER,false )
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.PARTY ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.PARTY,false ) 
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.GUILD ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.GUILD,false ) 
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.ALLIANCE ]      = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.ALLIANCE,false ) 
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.EMOTE ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.EMOTE,false ) 
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.YELL ]          = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.YELL,false )  
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.SYSTEM ]        = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.SYSTEM,false )  
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.PRIVATE ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.PRIVATE,false )  
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.CUSTOM ]        = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.CUSTOM,false )  -- CHAT
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.GESTURE ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.GESTURE,false )  
		NewChatWindow.ChannelsEnabled[i][ SystemData.ChatLogFilters.GM ]            = CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. SystemData.ChatLogFilters.GM,true )  
		NewChatWindow.ChannelsEnabled[i][ 14 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. 14,false )  -- DAMAGE FILTER
		NewChatWindow.ChannelsEnabled[i][ 15 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. 15,false )  -- You See
		NewChatWindow.ChannelsEnabled[i][ 16 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. i .. 16,false )  -- Note to self
    end
    
    
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.SAY ]           = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.SAY,NewChatWindow.DefaultFont )
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.WHISPER ]       = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.WHISPER,NewChatWindow.DefaultFont )
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.PARTY ]         = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.PARTY,NewChatWindow.DefaultFont ) 
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.GUILD ]         = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.GUILD,NewChatWindow.DefaultFont ) 
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.ALLIANCE ]      = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.ALLIANCE,NewChatWindow.DefaultFont ) 
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.EMOTE ]         = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.EMOTE,NewChatWindow.DefaultFont ) 
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.YELL ]          = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.YELL,NewChatWindow.DefaultFont )  
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.SYSTEM ]        = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.SYSTEM,NewChatWindow.DefaultFont )  
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.PRIVATE ]       = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.PRIVATE,NewChatWindow.DefaultFont )  
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.CUSTOM ]        = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.CUSTOM,NewChatWindow.DefaultFont )  
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.GESTURE ]       = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.GESTURE,NewChatWindow.DefaultFont )  
    NewChatWindow.ChannelsFonts[ SystemData.ChatLogFilters.GM ]            = CustomSettings.LoadNumber( "ChannelsFonts" .. SystemData.ChatLogFilters.GM,NewChatWindow.DefaultFont ) 
    NewChatWindow.ChannelsFonts[ 14 ]										 = CustomSettings.LoadBoolean( "ChannelsFonts14",NewChatWindow.DefaultFont )  -- DAMAGE FILTER
    NewChatWindow.ChannelsFonts[ 15 ]										= CustomSettings.LoadBoolean( "ChannelsFonts15",NewChatWindow.DefaultFont )  -- You See
    NewChatWindow.ChannelsFonts[ 16 ]										= CustomSettings.LoadBoolean( "ChannelsFonts16",NewChatWindow.DefaultFont )  -- Note to self
    
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.SAY ]           = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.SAY,NewChatWindow.DefaultFontSize )
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.WHISPER ]       = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.WHISPER,NewChatWindow.DefaultFontSize )
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.PARTY ]         = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.PARTY,NewChatWindow.DefaultFontSize ) 
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.GUILD ]         = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.GUILD,NewChatWindow.DefaultFontSize ) 
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.ALLIANCE ]      = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.ALLIANCE,NewChatWindow.DefaultFontSize ) 
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.EMOTE ]         = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.EMOTE,NewChatWindow.DefaultFontSize ) 
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.YELL ]          = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.YELL,NewChatWindow.DefaultFontSize )  
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.SYSTEM ]        = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.SYSTEM,NewChatWindow.DefaultFontSize )  
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.PRIVATE ]       = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.PRIVATE,NewChatWindow.DefaultFontSize )  
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.CUSTOM ]        = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.CUSTOM,NewChatWindow.DefaultFontSize )  
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.GESTURE ]       = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.GESTURE,NewChatWindow.DefaultFontSize )  
    NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.GM ]            = CustomSettings.LoadNumber( "ChannelsFontsSize" .. SystemData.ChatLogFilters.GM,NewChatWindow.DefaultFontSize ) 
    NewChatWindow.ChannelsFontsSize[ 14 ]											= CustomSettings.LoadBoolean( "ChannelsFontsSize14" ,NewChatWindow.DefaultFontSize  )  -- DAMAGE FILTER
    NewChatWindow.ChannelsFontsSize[ 15 ]											= CustomSettings.LoadBoolean( "ChannelsFontsSize15" ,NewChatWindow.DefaultFontSize  )  -- You see
    NewChatWindow.ChannelsFontsSize[ 16 ]											= CustomSettings.LoadBoolean( "ChannelsFontsSize16" ,NewChatWindow.DefaultFontSize  )  -- Note to self
   
   NewChatWindow.BaseAlpha = CustomSettings.LoadNumber( "NewChatWindowBaseAlpha",NewChatWindow.BaseAlpha )
	if (NewChatWindow.BaseAlpha < 0.01) then
		NewChatWindow.BaseAlpha = 0.01
	end 
  
   
   	NewChatWindow.autoHide = CustomSettings.LoadBoolean( "NewChatWindowAutoHide",NewChatWindow.autoHide )
   	NewChatWindow.showMouseOver = CustomSettings.LoadBoolean( "NewChatWindowshowMouseOver",NewChatWindow.showMouseOver )
   	NewChatWindow.waitTime = CustomSettings.LoadNumber( "NewChatWindowwaitTime",NewChatWindow.waitTime )
   	NewChatWindow.ActiveTab = CustomSettings.LoadNumber( "NewChatWindowActiveTab",NewChatWindow.ActiveTab )
   	NewChatWindow.TextFade = CustomSettings.LoadBoolean( "NewChatWindowTextFade",NewChatWindow.TextFade )
   	NewChatWindow.TimeStamp = CustomSettings.LoadBoolean( "NewChatWindowTimeStamp",NewChatWindow.TimeStamp )
	NewChatWindow.Locked = CustomSettings.LoadBoolean( "NewChatWindowLocked",NewChatWindow.Locked )
	NewChatWindow.firstStart = CustomSettings.LoadBoolean( "NewChatWindowfirstStart",NewChatWindow.firstStart )
	NewChatWindow.minTotDmg = CustomSettings.LoadNumber( "NewChatWindowminTotDmg",NewChatWindow.minTotDmg )
	
	NewChatWindow.ShowSpells = CustomSettings.LoadBoolean( "NewChatWindowShowSpells",NewChatWindow.ShowSpells )
	NewChatWindow.ShowSpellsCasting = CustomSettings.LoadBoolean( "NewChatWindowShowSpellsCasting",NewChatWindow.ShowSpellsCasting )
	 
	NewChatWindow.ShowPerfection = CustomSettings.LoadBoolean( "NewChatWindowShowPerfection",NewChatWindow.ShowPerfection )
	NewChatWindow.ShowMultiple = CustomSettings.LoadBoolean( "NewChatWindowShowMultiple",NewChatWindow.ShowMultiple )
	 
	NewChatWindow.hideTag = CustomSettings.LoadBoolean( "NewChatWindowhideTag",NewChatWindow.hideTag )
	 
	WindowSetShowing("NewChatWindowResizeButton", not NewChatWindow.Locked)

	 
	NewChatWindow.TabCount = CustomSettings.LoadNumber( "NewChatWindowTabCount",NewChatWindow.TabCount )
   ...
   WindowSetDimensions("NewChatWindow", 400, 200)
	...
	LabelSetText( barName .. "Text", UI.GetCliloc(SystemData.Settings.Language.type, 749))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 750))
	...
	LabelSetText( barName .. "Text", UI.GetCliloc(SystemData.Settings.Language.type, 751))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 752))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 762))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 763))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 754))
	WindowAddAnchor(templatename, "bottomleft", "TimeStamp", "topleft", 0 , 20)
	
	
	barName = "MinTotDamage"
	CreateWindowFromTemplate( barName, "SliderItemTemplate", "NewChatSettingsWindowScrollChildText" )
	WindowAddAnchor( barName, "bottomleft", "LockWindow", "topleft", 0, 40 )
	LabelSetText( barName .. "Text", UI.GetCliloc(SystemData.Settings.Language.type, 771))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 770))
	...
	for i = 2, table.getn(NewChatWindow.Filter) do
		...
		CreateWindowFromTemplate( templatename, "LabelCheckButton", "NewChatSettingsWindowScrollChildText" )
		ButtonSetCheckButtonFlag( templatename.."Button", true )
		NewChatWindow.SavedFilter[i] = CustomSettings.LoadBoolean( "NewChatYSFilter"..i, NewChatWindow.SavedFilter[i] )
	...
	CreateWindowFromTemplate( templatename, "SubSectionLabelTemplate", "NewChatSettingsWindowScrollChildText" )
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 772))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 773))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 774))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 775))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 776))
	...
	LabelSetText(templatename.."Label", UI.GetCliloc(SystemData.Settings.Language.type, 777))
...
function NewChatWindow.LoadTabs()
	...
	for i = 1, NewChatWindow.TabCount do
		...
		if (NewChatWindow.firstStart and i == 1) then
			CustomSettings.SaveBoolean( "NewChatWindowfirstStart",false )
			txt = L"Journal"
			CustomSettings.SaveWString( "NewChatWindowTabName" .. i ,txt )
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.SAY,true )
			 CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.WHISPER,true )
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.PARTY,true ) 
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GUILD,true ) 
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.ALLIANCE,true ) 
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.EMOTE,true ) 
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.YELL,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.SYSTEM,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.PRIVATE,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.CUSTOM,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GESTURE,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GM,true )  
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. 14,true )  -- DAMAGE FILTER
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. 15,true )  -- You See
			CustomSettings.SaveBoolean( "ChannelsEnabled" .. 1 .. 16,true )  -- Note to self
			
			NewChatWindow.ChannelsEnabled[1] = {}
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.SAY ]           = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.SAY,true )
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.WHISPER ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.WHISPER,true )
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.PARTY ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.PARTY,true ) 
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.GUILD ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GUILD,true ) 
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.ALLIANCE ]      = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.ALLIANCE,true ) 
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.EMOTE ]         = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.EMOTE,true ) 
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.YELL ]          = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.YELL,true )  
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.SYSTEM ]        = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.SYSTEM,true )  
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.PRIVATE ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.PRIVATE,true )  
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.CUSTOM ]        = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.CUSTOM,true )  
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.GESTURE ]       = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GESTURE,true )  
			NewChatWindow.ChannelsEnabled[1][ SystemData.ChatLogFilters.GM ]            = CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. SystemData.ChatLogFilters.GM,true )  
			NewChatWindow.ChannelsEnabled[1][ 14 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. 14,true )  -- DAMAGE FILTER
			NewChatWindow.ChannelsEnabled[1][ 15 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. 15,true )  -- You See
			NewChatWindow.ChannelsEnabled[1][ 16 ]										= CustomSettings.LoadBoolean( "ChannelsEnabled" .. 1 .. 16,true )  -- Note to self
		end
		if (SystemData.Settings.Language.type == SystemData.Settings.Language.LANGUAGE_ENU) then
			LabelSetFont(templatename.."Text",  "font_verdana_bold_shadow_med2_14", WindowUtils.FONT_DEFAULT_TEXT_LINESPACING)
		else
			LabelSetFont(templatename.."Text",  "UO_DefaultText_16", WindowUtils.FONT_DEFAULT_TEXT_LINESPACING)
			WindowClearAnchors(templatename.."Text")
			WindowAddAnchor(templatename.."Text", "topleft", templatename, "topleft", 5 , 3)
			
		end
		LabelSetText(templatename.."Text", CustomSettings.LoadWString( "NewChatWindowTabName" .. i ,txt ))
		WindowClearAnchors(templatename)
		NewChatWindow.TabStatus[i] = { extracted = CustomSettings.LoadBoolean( "NewChatWindowTabExtracted" .. i, false ) }
...
function NewChatWindow.BookmarkContext()
	...
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 756),0,"rename",bookmarkIndex,false)
	local enable = 0
	if (NewChatWindow.TabCount >= NewChatWindow.maxTabs) then
		enable = 1
	end
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 760),enable,"add",bookmarkIndex,false)
	
	enable = 0
	if (NewChatWindow.TabCount <= 1) then
		enable = 1
	end
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 759),enable,"remove",bookmarkIndex,false)
	
	
	if (NewChatWindow.TabStatus[bookmarkIndex] and NewChatWindow.TabStatus[bookmarkIndex].extracted) then
		ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 761),0,"reintegrate",bookmarkIndex,false)
	else
		if (NewChatWindow.LastDock > 1) then
			ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 755),0,"extract",bookmarkIndex,false)
		else
			ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 755),1,"extract",bookmarkIndex,false)
		end
	end
	...
	local val = { str = UI.GetCliloc(SystemData.Settings.Language.type, 769),flags=0,param=bookmarkIndex, returnCode=14,pressed=NewChatWindow.ChannelsEnabled[bookmarkIndex][14]}
	table.insert(subMenu, val)
	local val = { str = UI.GetCliloc(SystemData.Settings.Language.type, 768),flags=0,param=bookmarkIndex, returnCode=15,pressed=NewChatWindow.ChannelsEnabled[bookmarkIndex][15]}
	table.insert(subMenu, val)
	local val = { str = UI.GetCliloc(SystemData.Settings.Language.type, 654),flags=0,param=bookmarkIndex, returnCode=16,pressed=NewChatWindow.ChannelsEnabled[bookmarkIndex][16]}
	table.insert(subMenu, val)
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 757),0,0,"null",false,subMenu)
		
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 764),0,"save",bookmarkIndex,false)
...
function NewChatWindow.BookmarkContextMenuCallback( returnCode, param )
	...
	if (returnCode == "extract") then
		...
		CustomSettings.SaveBoolean( "NewChatWindowTabExtracted" .. param, NewChatWindow.TabStatus[param].extracted )
	...
	elseif (returnCode == "save") then
		...
		local path = "logs/" .."[" .. clockstring .. "] " ..  WStringToString(CustomSettings.LoadWString( "NewChatWindowTabName" .. param ,L"ChatTab" )) .. ".txt"
	...
	elseif (returnCode == "rename") then
		local rdata = {title=UI.GetCliloc(SystemData.Settings.Language.type, 756), subtitle=UI.GetCliloc(SystemData.Settings.Language.type, 758), callfunction=NewChatWindow.BookmarkRename, id=param}
		RenameWindow.Create(rdata)
	elseif (returnCode == "remove") then
		NewChatWindow.TabCount = NewChatWindow.TabCount - 1
		CustomSettings.SaveNumber( "NewChatWindowTabCount",NewChatWindow.TabCount )
		for j = param + 1, NewChatWindow.maxTabs do
			CustomSettings.SaveWString( "NewChatWindowTabName" .. j-1 ,CustomSettings.LoadWString( "NewChatWindowTabName" .. j ,L"ChatTab" ) )
			NewChatWindow.TabStatus[j-1] = false
			CustomSettings.SaveBoolean( "NewChatWindowTabExtracted" .. j-1, false )
		end
		for j = 1, NewChatWindow.maxTabs do
			NewChatWindow.TabStatus[j] = { extracted = false  }
			CustomSettings.SaveBoolean( "NewChatWindowTabExtracted" .. j, NewChatWindow.TabStatus[j].extracted )
		end
	...
	elseif (returnCode == "add") then
		NewChatWindow.TabCount = NewChatWindow.TabCount + 1
		CustomSettings.SaveNumber( "NewChatWindowTabCount",NewChatWindow.TabCount )
		CustomSettings.SaveWString( "NewChatWindowTabName" .. NewChatWindow.TabCount ,L"ChatTab" )
		for i = 1, table.getn(ChatSettings.Channels) do
			NewChatWindow.ChannelsEnabled[NewChatWindow.TabCount][i] = false or i == SystemData.ChatLogFilters.GM
			CustomSettings.SaveBoolean( "ChannelsEnabled".. NewChatWindow.TabCount .. i,NewChatWindow.ChannelsEnabled[NewChatWindow.TabCount][i] ) 
		end
		NewChatWindow.LoadTabs()
	elseif( tonumber(returnCode) ) then
		...
		CustomSettings.SaveBoolean( "ChannelsEnabled".. param .. returnCode,NewChatWindow.ChannelsEnabled[param][returnCode] ) 
...
function NewChatWindow.BookmarkRename(id, text)
	...
	CustomSettings.SaveWString( "NewChatWindowTabName" .. id ,text )
	local templatename = "Bookmark" .. id
	LabelSetText(templatename.."Text", CustomSettings.LoadWString( "NewChatWindowTabName" .. id ,L"ChatTab" ))
end


function NewChatWindow.LabelOnMouseOver()
	--Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name, UI.GetCliloc(SystemData.Settings.Language.type, 366))
	--Tooltips.Finalize()
...
function NewChatWindow.SwitchTab()
	...
	CustomSettings.SaveNumber( "NewChatWindowActiveTab",NewChatWindow.ActiveTab )
	for i = 1, NewChatWindow.TabCount do
...
function NewChatWindow.RubberToolTip()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name,UI.GetCliloc(SystemData.Settings.Language.type, 743) )
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end
...
function NewChatWindow.Font()
	...
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 769),0,14,1,false)
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 768),0,15,1,false)
	ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 654),0,16,1,false)
...
function NewChatWindow.FontToolTip()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name,UI.GetCliloc(SystemData.Settings.Language.type, 744) )
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end
...
function NewChatWindow.FontSize()
	...
	ContextMenu.CreateLuaContextMenuItemWithString(ChatSettings.Channels[SystemData.ChatLogFilters.GM].name .. L" (" .. NewChatWindow.ChannelsFontsSize[ SystemData.ChatLogFilters.GM ] .. L")",0,SystemData.ChatLogFilters.GM,1,false)
		ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 769) .. L" (" .. NewChatWindow.ChannelsFontsSize[ 14 ] .. L")",0,14,1,false)
		ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 768) .. L" (" .. NewChatWindow.ChannelsFontsSize[ 15 ] .. L")",0,15,1,false)
		ContextMenu.CreateLuaContextMenuItemWithString(UI.GetCliloc(SystemData.Settings.Language.type, 654) .. L" (" .. NewChatWindow.ChannelsFontsSize[ 16 ] .. L")",0,16,1,false)
...
function NewChatWindow.FontSizeContextMenuCallback( returnCode, param )
	...
	local rdata = {title=UI.GetCliloc(SystemData.Settings.Language.type, 745), subtitle=UI.GetCliloc(SystemData.Settings.Language.type, 746), callfunction=NewChatWindow.SetFontSize, id=returnCode}
	RenameWindow.Create(rdata)
end
...
function NewChatWindow.SetFontSize(id, px)
	...
	CustomSettings.SaveNumber( "ChannelsFontsSize" .. id,NewChatWindow.ChannelsFontsSize[ id ] ) 
	NewChatWindow.ClearAll()
	NewChatWindow.UpdateLog()
end

function NewChatWindow.FontSizeToolTip()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name,UI.GetCliloc(SystemData.Settings.Language.type, 745) )
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end
...
function NewChatWindow.FontColorToolTip()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name,UI.GetCliloc(SystemData.Settings.Language.type, 747) )
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end

function NewChatWindow.ChatSettingsToolTip()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name,UI.GetCliloc(SystemData.Settings.Language.type, 748) )
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end
...
function NewChatWindow.OnSettingsHidden()
	...
	CustomSettings.SaveNumber( "NewChatWindowBaseAlpha",barVal )
	...
	CustomSettings.SaveNumber( "NewChatWindowwaitTime",NewChatWindow.waitTime )
	...
	CustomSettings.SaveNumber( "NewChatWindowminTotDmg",NewChatWindow.minTotDmg )
	...
	CustomSettings.SaveBoolean( "NewChatWindowAutoHide", NewChatWindow.autoHide ) 
	
	NewChatWindow.showMouseOver = ButtonGetPressedFlag("ShowMouseOverButton")
	CustomSettings.SaveBoolean( "NewChatWindowshowMouseOver", NewChatWindow.showMouseOver ) 
	
	NewChatWindow.TextFade = ButtonGetPressedFlag("FadeTextButton")
	CustomSettings.SaveBoolean( "NewChatWindowTextFade", NewChatWindow.TextFade )
	
	NewChatWindow.TimeStamp = ButtonGetPressedFlag("TimeStampButton")
	CustomSettings.SaveBoolean( "NewChatWindowTimeStamp", NewChatWindow.TimeStamp )
	
	NewChatWindow.Locked = ButtonGetPressedFlag("LockWindowButton")
	CustomSettings.SaveBoolean( "NewChatWindowLocked", NewChatWindow.Locked ) 
	 for j = 1, NewChatWindow.maxTabs do
		local templatename = "NewChatWindow" .. j .."ResizeButton"
		if (DoesWindowNameExist( templatename)) then
			WindowSetShowing(templatename, not NewChatWindow.Locked)
	...
	for i = 2, table.getn(NewChatWindow.Filter) do
		...
		CustomSettings.SaveBoolean( "NewChatYSFilter"..i, NewChatWindow.SavedFilter[i] )
	end
	
	NewChatWindow.ShowSpells = ButtonGetPressedFlag("SpellsButton")
	CustomSettings.SaveBoolean( "NewChatWindowShowSpells", NewChatWindow.ShowSpells )
	
	NewChatWindow.ShowSpellsCasting = ButtonGetPressedFlag("SpellsCastingButton")
	CustomSettings.SaveBoolean( "NewChatWindowShowSpellsCasting", NewChatWindow.ShowSpellsCasting )
	
	NewChatWindow.ShowPerfection = ButtonGetPressedFlag("PerfectionMsgsButton")
	CustomSettings.SaveBoolean( "NewChatWindowShowPerfection", NewChatWindow.ShowPerfection )
	
	NewChatWindow.ShowMultiple = ButtonGetPressedFlag("PreventsMultipleButton")
	CustomSettings.SaveBoolean( "NewChatWindowShowMultiple", NewChatWindow.ShowMultiple )
	
	NewChatWindow.hideTag = ButtonGetPressedFlag("HideTagsButton")
	CustomSettings.SaveBoolean( "NewChatWindowhideTag", NewChatWindow.hideTag )
