...
function CrystalPortal.Initialize()
	WindowSetDimensions(CrystalPortal.WindowName, 690,520)
	...
	CrystalPortal.LastMap = CustomSettings.LoadNumber( "CrystalPortalMap", 1 )
	CrystalPortal.LastArea = CustomSettings.LoadNumber( "CrystalPortalArea", 3 )
	CrystalPortal.LastSelection = CustomSettings.LoadNumber( "CrystalPortalSelection", 1 )
end
...
function CrystalPortal.ChangeImage()
	DynamicImageSetTexture(CrystalPortal.WindowName .."Image", "", 0,0)
	local idx = ComboBoxGetSelectedMenuItem(CrystalPortal.WindowName .. "DestCombo")
	if (idx == 0) then
		return
	end
	...
	if (ButtonGetPressedFlag( CrystalPortal.WindowName .. "DungeonButton")) then
		...
		DynamicImageSetTexture(CrystalPortal.WindowName .."Image", base[idx].texture, 0,0)
	elseif (ButtonGetPressedFlag( CrystalPortal.WindowName .. "MoongateButton")) then
		base = base.Moongates
		DynamicImageSetTexture(CrystalPortal.WindowName .."Image", base[idx].texture, 0,0)
	elseif (ButtonGetPressedFlag( CrystalPortal.WindowName .. "BankButton")) then
...
function CrystalPortal.GO()
	...
	CustomSettings.SaveNumber( "CrystalPortalMap" , CrystalPortal.LastMap )
	...
	CustomSettings.SaveNumber( "CrystalPortalArea" , CrystalPortal.LastArea )
	...
	CustomSettings.SaveNumber( "CrystalPortalSelection" , CrystalPortal.LastSelection )
