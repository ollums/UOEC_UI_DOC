...
MacroPickerWindow.MacroIcons = {
								...
								660, 661, 652, 653, 654, 662, 663, 664, 665,
								667, 668, 669, 670, 672, 673, 674, 675, 676,
								677, 694, 695,
								...
								3001, 3002, 3003, 3004, 3011, 3012, 3013, 3014, 3015,
								3016, 3021, 3022, 3023, 3024, 3025
							}
...
function MacroPickerWindow.DrawMacroTable(parent)
    ...
    for index, iconId in ipairs(MacroPickerWindow.MacroIcons) do
        ...
        if (iconId ~= 620) then
			...
			DynamicImageSetTexture( currentMacroWindowName, MiniTexturePack.DB[MiniTexturePack.Current].texture .. "Icon", x, y )
		end
