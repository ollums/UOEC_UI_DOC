...
function BugReportWindow.Hide()
    ToggleWindowByName( "BugReportWindow", MenuBarWindow.ToggleReportBugWindow, BugReportWindow.OnOpen, BugReportWindow.OnClose )
end
...
function BugReportWindow.SelectBugType( type )
    ...
    if BugReportWindow.selectedType == BugReportWindow.bugTypes.BUG_UI	 then
		 LabelSetText( "BugReportWindowLabel", GetStringFromTid(BugReportWindow.TID.Description) .. UI.GetCliloc(SystemData.Settings.Language.type, 7028) )
    else
		 LabelSetText( "BugReportWindowLabel", GetStringFromTid(BugReportWindow.TID.Description) )
    end
...
function BugReportWindow.OnSubmit() 
    ...
    if BugReportWindow.selectedType == BugReportWindow.bugTypes.BUG_UI	 then
		SendBugReportUI(BugReportText.Text)
    else
