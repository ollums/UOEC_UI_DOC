...
function UserWaypointWindow.ScaleUpOnMouseOver()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name, L"Big Icon")
	Tooltips.Finalize()
...
function UserWaypointWindow.ScaleDownOnMouseOver()
	Tooltips.CreateTextOnlyTooltip(SystemData.ActiveWindow.name, L"Small Icon")
	Tooltips.Finalize()
	Tooltips.AnchorTooltip( Tooltips.ANCHOR_WINDOW_TOP )
end
