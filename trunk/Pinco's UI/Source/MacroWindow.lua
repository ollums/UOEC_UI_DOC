...
function MacroWindow.OnClose()
    ButtonSetPressedFlag("MenuBarWindowToggleMacros",false)
end
...
function MacroWindow.DisplayMacroList()
    ...
    for i=1,numMacros do
        ...
        if (iconId == 620) then
			DynamicImageSetTexture( currentMacroWindowName.."SquareIcon", MiniTexturePack.DB[MiniTexturePack.Current].texture .. "Icon", x, y )
		else
...
function MacroWindow.PickupMacro()
