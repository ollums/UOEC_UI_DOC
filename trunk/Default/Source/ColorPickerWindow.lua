...
function ColorPickerWindow.DrawColorTable(parent)
    ...
    local windowHeight = ( math.ceil((table.getn(ColorPickerWindow.colorTables[parent])/ColorPickerWindow.numColorsPerRow)) * ColorPickerWindow.swatchSize) + ColorPickerWindow.yPadding
