...
MenuBarWindow.MenuBarData["MenuBarWindowWarButton"] = {}
MenuBarWindow.MenuBarData["MenuBarWindowWarButton"].ToolTipTid = 1079841 -- War/Peace
MenuBarWindow.MenuBarData["MenuBarWindowWarButton"].ToggleWindow = nil
...
MenuBarWindow.MinimizedOffset = 403
...
function MenuBarWindow.Initialize()
	...
	WindowUtils.RestoreWindowPosition("MenuBarWindow", nil, nil, false)
	WindowUtils.RestoreWindowPosition("MenuBarWindowMinimized", nil, nil, false)
...
function MenuBarWindow.Shutdown()
	...
	if (MenuBarWindow.CurState == MenuBarWindow.MINIMIZED) then
		WindowUtils.CopyScreenPosition("MenuBarWindowMinimized", "MenuBarWindow", 0, 0 )
	end
