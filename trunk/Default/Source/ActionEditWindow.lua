...
function ActionEditWindow.UpdateTextEdit(editWindow, hotbarId, itemIndex, subIndex)
...
function ActionEditWindow.OpenEditWindow(actionType,anchorWindow,hotbarId,itemIndex,subIndex)
	...
	if( actionData ~= nil and actionData.editWindow ~= nil ) then
		...
		if( UserActionIsSpeechType(hotbarId, itemIndex, subIndex) == true ) then
			ActionEditWindow.UpdateTextEdit(windowName, hotbarId, itemIndex, subIndex)
