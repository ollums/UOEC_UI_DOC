...
function ChannelWindow.Initialize()
	...
	ButtonSetPressedFlag("MenuBarWindowToggleChat",true)
end

function ChannelWindow.Shutdown()
	ButtonSetPressedFlag("MenuBarWindowToggleChat",false)
end
...
function ChannelWindow.UpdateCurrentChannel()
	if(WindowData.CurrentChannel == L"") then
		LabelSetText("ChannelWindowCurrentChannelLabel", L"None")
